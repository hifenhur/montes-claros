...
class NoticiaControllerTest < ActionController::TestCase
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post :create, noticium: { conteudo: @noticium.conteudo, descricao: @noticium.descricao, titulo: @noticium.titulo }
    end
  ...
  test "should update noticium" do
    put :update, id: @noticium, noticium: { conteudo: @noticium.conteudo, descricao: @noticium.descricao, titulo: @noticium.titulo }
    assert_redirected_to noticium_path(assigns(:noticium))
  end
