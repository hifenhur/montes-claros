...
class ServicosControllerTest < ActionController::TestCase
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post :create, servico: { descricao: @servico.descricao, horario: @servico.horario, localizacao: @servico.localizacao, nome: @servico.nome, telefone: @servico.telefone }
    end
  ...
  test "should update servico" do
    put :update, id: @servico, servico: { descricao: @servico.descricao, horario: @servico.horario, localizacao: @servico.localizacao, nome: @servico.nome, telefone: @servico.telefone }
    assert_redirected_to servico_path(assigns(:servico))
  end
