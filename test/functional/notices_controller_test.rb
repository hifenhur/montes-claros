...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { conteudo: @notice.conteudo, descricao: @notice.descricao, titulo: @notice.titulo }
    end
  ...
  test "should update notice" do
    put :update, id: @notice, notice: { conteudo: @notice.conteudo, descricao: @notice.descricao, titulo: @notice.titulo }
    assert_redirected_to notice_path(assigns(:notice))
  end
